...
@Service
public class AdministratorSystemConfigurationSepSystemCurrencyUpdateService implements AbstractUpdateService<Administrator, SystemConfigurationSep>{
	@Autowired
	...
	public void bind(final Request<SystemConfigurationSep> request, final SystemConfigurationSep entity, final Errors errors) {
		...
		request.bind(entity, errors, "systemCurrency");
	}
