...
<acme:menu-bar code="master.menu.home">
	<acme:menu-left>
		...
		<acme:menu-option code="master.menu.anonymous" access="isAnonymous()">
			...
			<acme:menu-suboption code="master.menu.anonymous.ingredient.list" action="/any/ingredient/list"/>
		...
		<acme:menu-option code="master.menu.authenticated" access="isAuthenticated()">
			...
			<acme:menu-suboption code="master.menu.authenticated.ingredient.list" action="/any/ingredient/list"/>
		...
		<acme:menu-option code="master.menu.chef" access="hasRole('Chef')">
			<acme:menu-suboption code="master.menu.chef.ingredient.list" action="/chef/ingredient/list"/>
		</acme:menu-option>
