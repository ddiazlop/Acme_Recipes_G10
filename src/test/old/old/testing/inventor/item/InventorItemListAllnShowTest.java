...
public class InventorItemListAllnShowTest extends TestHarness {
	...
	@Order(10)
	public void positiveInventorHasComponentsTest(final int recordIndex, final String username, final String password, final String name, final String code, final String technology, final String description, final String retailPrice, final String info) {
	...
	@Order(10)
	public void positiveInventorHasToolsTest(final int recordIndex, final String username, final String password, final String name, final String code, final String technology, final String description, final String retailPrice, final String info) {
