...
public class PatronPatronageCreateService implements AbstractCreateService<Patron, Patronage> {
	...
	public void unbind(final Request<Patronage> request, final Patronage entity, final Model model) {
		...
		try {
			final Integer inventorId = entity.getInventor().getId();
			model.setAttribute("previd", inventorId);
	...
	public void validate(final Request<Patronage> request, final Patronage entity, final Errors errors) {
		...
		if (!errors.hasErrors("inventorId")) {
			...
			errors.state(request, entity.getInventor() != null, "inventorId", "patron.patronage.form.error.null-inventor");
		}
