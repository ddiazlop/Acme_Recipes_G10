...
public class InventorComponentCreateService implements AbstractCreateService<Inventor, Item>{
	...
	public void validate(final Request<Item> request, final Item entity, final Errors errors) {
		...
		if (!errors.hasErrors("name")) {
			final Boolean hasNoSpamName = spamDetector.stringHasNoSpam(entity.getName());
			errors.state(request, hasNoSpamName, "name", "spam.detector.error.message");
		}
		
		if (!errors.hasErrors("technology")) {
			final Boolean hasNoSpamTechnology = spamDetector.stringHasNoSpam(entity.getTechnology());
			errors.state(request, hasNoSpamTechnology, "technology", "spam.detector.error.message");
		}
